...
\section*{Einleitung}
In diesem Dokument werden die Lösungen für das erste Übungsblatt dargestellt. Die Aufgaben basieren auf dem Lehrbuch:
\begin{quote}
    \textit{Burg, K., Haf, H., Wille, F., \& Meister, A. (2012). Höhere Mathematik für Ingenieure, Band II: Lineare Algebra. Springer Vieweg.}
\end{quote}
...
\textbf{Repository:} 
\url{https://github.com/0xburo/math-for-machine-learning}
